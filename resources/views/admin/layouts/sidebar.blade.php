    ...
    <div class="app-sidebar colored">
        <div class="sidebar-header">
            <a class="header-brand" href="
                 @if (Auth::user()->role->name == 'Administrator') {{ route('admin.home') }} @endif ">
                    ...
                    @if (Auth::user()->role->name == 'Administrator')
                        ...
                        <div class="nav-item has-sub">
                            ...
                            <div class="submenu-content">
                                ...
                                <a href="{{ route('appointment.create') }}" class="menu-item">Utwórz na pojedynczy
                                    dzień</a>
                                <a href="{{ route('weekly_appointment.create') }}" class="menu-item">Utwórz na
                                    najbliższe tygodnie</a>
                            </div>
                        </div>
                        <div class="nav-item has-sub">
                        ...
                        <div class="nav-item">
                            <a href="{{ route('card_doctor.index') }}"><i class="ik ik-layers"></i><span>Karta
                                    lekarza</span></a>
                        </div>
                    @endif
                    @if (Auth::user()->role->name == 'Doktor')
                        <div class="nav-item">
                            <a href="{{ route('home.index') }}"><i class="ik ik-layers"></i><span>Strona
                                    główna</span></a>
                        </div>
                        <div class="nav-item has-sub">
                            <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Pacjenci</span></a>
                        ...
                        <div class="nav-item">
                            <a href="{{ route('patient_today.index') }}"><i class="ik ik-layers"></i><span>Dzisiejsze
                                    wizyty</span></a>
                        </div>
